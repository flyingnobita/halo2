// the same as field.rs, but with six limbs! #doom.
...
macro_rules! field_common {
    (
        ...
        impl $field {
            ...
            // need to edit this to be compatible with 6 limbs.
            // this means that we should have a from_u768 function.
            // it seems to me that their code works with the obvious edits.
            // I edit the code and the comments 
            // to reflect what one would need to check. 

            fn from_u768(limbs: [u64; 12]) -> $field {
                ...
                let d1 = $field([limbs[6], limbs[7], limbs[8], limbs[9], limbs[10], limbs[11]]);
        ...
        // modified length, think the $r2 is correct.
        impl From<u64> for $field {
            fn from(val: u64) -> $field {
                $field([val, 0, 0, 0, 0, 0]) * $r2
            }
        }
        // to not get type errors, modify this to be 6 limbs.
        ...
        // change to be compatible with six limbs
